...
func _ready():
	if Global.isDebugModeActive():
		learnedMoves = [MOVE.DASH_MOVE, MOVE.TWO_LIFE, MOVE.THREE_LIFE, MOVE.FIVE_LIFE, MOVE.LEAF_BLAST, MOVE.DOUBLE_LEAF_BLAST, MOVE.ROOT_SLASH]
